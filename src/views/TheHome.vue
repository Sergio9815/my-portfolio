          ...
          <section class="main__bg" :class="darkTheme ? 'primaryLight': 'primaryDark'">
              ...
              <div class="home" id="goInicio">
                <div class="home__desc">
                    ...
                    <AppButton
                      url="https://drive.google.com/file/d/1S_66NNE9IYL7P2Vq6HN9sbMoybgpwy0_/view?usp=sharing"
...
<script>
import AboutMe from '@/views/TheAbout.vue';
import Projects from '@/views/TheProjects.vue';
import SpTheme from '@/components/AppTheme.vue';
import AppButton from '../components/AppButton.vue';

export default {
  components: {
    AboutMe, Projects, SpTheme, AppButton,
  },
  name: 'Home',
  computed: {
    darkTheme: {
