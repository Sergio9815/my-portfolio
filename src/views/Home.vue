          ...
          <section class="main__bg">
              ...
              <div class="home" id="goInicio">
                <div class="home__desc">
                    ...
                    <a v-animate-css.hover="'pulse'" class="btn" href="https://drive.google.com/file/d/1LaatuZxFKpYOcuEkGLQ4EAWCHpEkX19N/view?usp=sharing">
                        Descargar CV
...
export default {
  components: { AboutMe, Projects, SpSocialBtn },
  name: 'Home',
};
</script>
<style scoped>
